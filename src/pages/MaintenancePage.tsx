          ...
          <div className="px-8 py-8">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                Nous effectuons actuellement des travaux de maintenance pour améliorer nos services et vous offrir une meilleure expérience.
              </p>
            </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-amber-700">
                    <strong className="font-medium">Le site sera de retour très bientôt.</strong>
                    <br />
                    Merci de votre patience pendant que nous améliorons nos services.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              ...
              <p className="text-gray-700 text-sm">
                Rejoignez notre Discord pour rester informé de l'avancement des travaux et obtenir de l'aide si nécessaire.
              </p>
            </div>
